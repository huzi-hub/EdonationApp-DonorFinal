...
class CartApp extends StatefulWidget {
  ...
  final fow;
  final fcm;
  CartApp(this.donorId, this.ngoId, this.fow, this.fcm);
  @override
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: <Widget>[
            ...
            widget.fow == 'food'
                ? CheckoutScreen(foodCart, widget.ngoId, widget.donorId,
                    widget.fow, widget.fcm)
                : widget.fow == 'clothes'
                    ? CheckoutScreen(clothesCart, widget.ngoId, widget.donorId,
                        widget.fow, widget.fcm)
                    : CheckoutScreen(bookCart, widget.ngoId, widget.donorId,
                        widget.fow, widget.fcm),
          ],
        ),
      ),
